...
2. Select "Yes" or "No" from the **"Do you Require Access to PHI Data"** pull down. More information here regarding using PHI Data on Wynton: [PHI Quickstart](https://wynton.ucsf.edu/hpc/get-started/phi-quickstart.html)
