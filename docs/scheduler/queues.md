...
* **member.q**:
  ...
  - Quota: Proportional to [your lab's contributed share]({{ site.baseurl }}/about/shares.html) on the cluster.  When a lab has exhausted all its available member.q slots, additional jobs scheduled by lab members will spill over to the long.q queue
...
[specify the resources]: {{ site.baseurl }}/scheduler/submit-jobs.html
