...
### Note Globus v.5 does not currently support putting you by default in your home directory, instead you will land in /wynton/. You will need to navigate from there to your home directory in /wynton/protected/home (or wherever you want to transfer your files).
