...
[development node]: {{ site.baseurl }}/about/specs.html#development-nodes
[login node]: {{ site.baseurl }}/about/specs.html#login-nodes
[SSH key pair]: {{ site.baseurl }}/howto/log-in-without-pwd.html
