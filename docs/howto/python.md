...
Collecting HTSeq
  Using cached https://files.pythonhosted.org/packages/e4/23/aca490d5cf3265dc4b97907231ebb7a4c5b666b4df8eeb815328bef5178b/HTSeq-1.99.2.tar.gz
    ...
    ----------------------------------------
Command "python setup.py egg_info" failed with error code 1 in ~/pip-build-jzkzf3qz/HTSeq/
```
...
Installing collected packages: zipp, importlib-resources, platformdirs, typing-extensions, importlib-metadata, distlib, six, filelock, virtualenv
...
created virtual environment CPython3.6.8.final.0-64 in 10249ms
