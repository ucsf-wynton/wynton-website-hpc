...
Versions: <span class="module-version">2.4.36, 2.4.37, 2.4.38, 2.4.39, 2.4.40, 2.4.41, <em>2.4.42</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">help([[
...
<h3 id="module_cbi_firefox" class="module-name">firefox</h3>
<dl>
  <dd class="module-details">
...
whatis(&quot;URL: https://www.firefox.com/, https://firefox-source-docs.mozilla.org/ (documentation), mozilla.org/en-US/firefox/notes (changelog), https://github.com/mozilla-firefox/firefox (source code), https://searchfox.org/firefox-main/source (source code)&quot;)
whatis([[
Description: 
...
Warning: <span class="module-warning">Only the most recent version of this software will be kept.</span><br>
Versions: <span class="module-version">7.3.0, <em>7.4.0</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">help([[
...
local libdir = pathJoin(home, &quot;lib&quot;)
prepend_path(&quot;CPATH&quot;,  pathJoin(home, &quot;include&quot;))
prepend_path(&quot;LDFLAGS&quot;, &quot;-L&quot; .. libdir, &quot; &quot;)
...
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">help([[
llmfit: Identify LLM Models &amp; Providers Supported on Current Hardware
]])

local name = myModuleName()
local version = myModuleVersion()
whatis(&quot;Version: &quot; .. version)
whatis(&quot;Keywords: utility, ai, llm&quot;)
whatis(&quot;URL: https://github.com/AlexsJones/llmfit (source code), https://github.com/AlexsJones/llmfit/releases (releases)&quot;)
whatis([[
...
<h3 id="module_cbi_ollama" class="module-name">ollama</h3>
<dl>
  <dd class="module-details">
<strong class="module-help">ollama: Start Building with Open Models</strong><br>
<span class="module-description">Get up and running with Kimi-K2.5, GLM-5, MiniMax, DeepSeek, gpt-oss, Qwen, Gemma and other models.
License: MIT</span><br>
...
if (mode() == &quot;load&quot;) then
  ...
  if not handle then
      LmodMessage(&quot;[&quot; .. name .. &quot;]: libcuda.so not found. GPU features may not work&quot;)
  end
end
</code></pre>
...
<h3 id="module_cbi_opencode" class="module-name">opencode</h3>
<dl>
  <dd class="module-details">
<strong class="module-help">opencode: The Open Source AI Coding Agent</strong><br>
...
local version = myModuleVersion()
whatis(&quot;Version: &quot; .. version)
whatis(&quot;Keywords: cli, ai&quot;)
whatis(&quot;URL: https://opencode.ai/, https://github.com/anomalyco/opencode/releases (releases), https://github.com/anomalyco/opencode (source code)&quot;)
whatis([[
Description: The open source AI coding agent. Free models included or connect any model from any provider, including Claude, GPT, Gemini and more.
Examples: `opencode --version`, `opencode --help`.
]]
)
...
<h3 id="module_cbi_symphony" class="module-name">symphony</h3>
<dl>
  <dd class="module-details">
<strong class="module-help">symphony: A Solver for Mixed-Integer Linear Programs (MILPs)</strong><br>
<span class="module-description">SYMPHONY is an open-source solver, callable library, and development framework for mixed-integer linear programs (MILPs) written in C with a number of unique features</span><br>
Example: <span class="module-example"><code>symphony --version</code>, <code>symphony --help</code>, and <code>clp</code>.</span><br>
URL: <span class="module-url"><a href="https://github.com/coin-or/SYMPHONY">https://github.com/coin-or/SYMPHONY</a>, <a href="https://github.com/coin-or/SYMPHONY/wiki">https://github.com/coin-or/SYMPHONY/wiki</a> (documentation), <a href="https://github.com/coin-or/SYMPHONY/releases/">https://github.com/coin-or/SYMPHONY/releases/</a> (releases), <a href="https://github.com/coin-or/SYMPHONY">https://github.com/coin-or/SYMPHONY</a> (source code)</span><br>
Versions: <span class="module-version"><em>5.7.3</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">help([[
symphony: A Solver for Mixed-Integer Linear Programs (MILPs)
]])
...
whatis(&quot;Version: &quot; .. version)
whatis(&quot;Keywords: library&quot;)
whatis(&quot;URL: https://github.com/coin-or/SYMPHONY, https://github.com/coin-or/SYMPHONY/wiki (documentation), https://github.com/coin-or/SYMPHONY/releases/ (releases), https://github.com/coin-or/SYMPHONY (source code)&quot;)
whatis([[
...
Examples: `symphony --version`, `symphony --help`, and `clp`.
]])
...
-- Required to by R package 'Rsymphony'
...
<h3 id="module_cbi_uv" class="module-name">uv</h3>
<dl>
  <dd class="module-details">
...
local version = myModuleVersion()
whatis(&quot;Version: &quot; .. version)
whatis(&quot;Keywords: utility, python&quot;)
...
<h3 id="module_sali_alphafold3" class="module-name">alphafold3</h3>
<dl>
  <dd class="module-details">
<span class="module-description">AlphaFold 3 (Sali Lab GPU cluster only)</span><br>
URL: <span class="module-url"><a href="https://github.com/google-deepmind/alphafold3">https://github.com/google-deepmind/alphafold3</a></span><br>
Versions: <span class="module-version"><em>3.0.3</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">#%Module 1.0
module-whatis &quot;Description: AlphaFold 3 (Sali Lab GPU cluster only)&quot;
module-whatis &quot;URL: https://github.com/google-deepmind/alphafold3&quot;
if { ! [file exists /home/alphafold3/container/alphafold3.sif ] } {
  puts stderr &quot;Sorry, this module only works in the Sali Lab, on sali-gpu1&quot;
  break
}

prepend-path	PATH	/home/alphafold3/bin
</code></pre>
...
<h3 id="module_sali_python3-dataclasses" class="module-name">python3/dataclasses</h3>
<dl>
  <dd class="module-details">
<span class="module-description">A backport of the dataclasses module for Python 3.6</span><br>
URL: <span class="module-url"><a href="https://pypi.org/project/dataclasses/">https://pypi.org/project/dataclasses/</a></span><br>
Versions: <span class="module-version"><em>0.8</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">#%Module 1.0

module-whatis &quot;Description: A backport of the dataclasses module for Python 3.6&quot;
module-whatis &quot;URL: https://pypi.org/project/dataclasses/&quot;
conflict python2
prepend-path PYTHONPATH      /salilab/diva1/programs/linux/dataclasses-0.8/lib/python/site-packages
</code></pre>
...
Versions: <span class="module-version">1.8, 2.5, 2.7, 2.9, <em>2.11</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">#%Module 1.0
...
prepend-path PYTHONPATH      /salilab/diva1/programs/x86_64linux/ihm-2.11/lib64/python/site-packages
</code></pre>
...
conflict python2
prepend-path  PYTHONPATH   /salilab/diva1/programs/linux/six-1.16.0/lib/python
</code></pre>
