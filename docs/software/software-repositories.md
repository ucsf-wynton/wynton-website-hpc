...
The R programming language. Examples: <code>R --version</code> and <code>Rscript --version</code>.<br>
  ...
  Versions: 2.12.2, 2.13.0, 2.14.0, 2.15.0, 3.0.0, 3.1.0, 3.2.0, 3.3.0, 3.4.0, 3.5.0, 3.5.3, 3.6.0, 3.6.1, <em>3.6.2</em><br>
  </dd>
...
_The above information was automatically generated on 2020-01-04 11:04:31 from querying `module avail` and `module spider`._
