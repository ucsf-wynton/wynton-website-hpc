...
_The above information was automatically generated on 2022-02-16 15:57:02 from querying `module avail` and `module spider`._
...
$(document).ready(function() {
  ...
  if (hash.startsWith(pattern_repo)) {
    ...
    var repo_module = hash.substring(pattern_repo.length);
