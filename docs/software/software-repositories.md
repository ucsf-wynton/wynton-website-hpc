...
<dl>
  ...
  Versions: <span class="module-version">2.12.2, 2.13.0, 2.14.0, 2.15.0, 3.0.0, 3.1.0, 3.2.0, 3.3.0, 3.4.0, 3.5.0, 3.5.3, 3.6.0, 3.6.1, 3.6.2, 3.6.3, 4.0.0, 4.0.1, 4.0.2, 4.0.3, 4.0.4, <em>4.0.5</em></span><br>
  </dd>
  ...
  <dd class="module-details">
    ...
    Warning: <span class="module-warning">To work around a bug where <code>fasterq-dump</code> crashes the local machine, it has been tweaked such that it uses <code>$TMPDIR</code> rather than <code>$PWD</code> as the default temporary folder.</span><br>
...
_The above information was automatically generated on 2021-08-09 10:17:20 from querying `module avail` and `module spider`._
